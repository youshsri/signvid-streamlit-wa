...
def does_file_exist(word):
    ...
    filename = r'/Users/hugofrelin/Desktop/Github/live-sign-subtitles/Git_Dataset/' + str(word) + ".mp4"
...
def get_signs(transcript, videolength):
    ...
    if len(video_array) > 0:
        ...
        return VideoFileClip(r'/Users/hugofrelin/Desktop/Github/live-sign-subtitles/Git_Dataset/blackscreen.mp4')
    ...
    # If it is shorter, we fill out the end with a black sreen.
        ...
        blackscreen = VideoFileClip(r'/Users/hugofrelin/Desktop/Github/live-sign-subtitles/Git_Dataset/blackscreen.mp4')
